...
<p align="center"><b>Zero-Dependency Agent Skills</b></p>
<p align="center">Pure markdown skills for Claude Code, OpenClaw, Cursor, and any AI agent. Copy a folder, get a capability.</p>
...
- [**Agent Soul**](https://github.com/aptratcn/skill-agent-soul) — Personality, values, taste, and growth for AI agents
...
- [**Token Analyzer**](https://github.com/aptratcn/skill-token-analyzer) — Retroactive analysis and hotspot detection
...
- [**Skill Quality Evaluator**](https://github.com/aptratcn/skill-quality-eval) — Assess skill output quality
- [**Cross-Tool Skill Sync**](https://github.com/aptratcn/cross-tool-skill-sync) — Write once, deploy everywhere

### ⚙️ DevOps & Infrastructure
- [**GitOps Flow**](https://github.com/aptratcn/skill-gitops-flow) — Blue-green, canary deployments with CI/CD templates
- [**Model Router**](https://github.com/aptratcn/skill-model-router) — Route tasks to the right model, save 70% cost
- [**Release Cop**](https://github.com/aptratcn/skill-release-cop) — Automated changelogs from git history

### 📊 Analysis & Visualization
- [**Trend Harvester**](https://github.com/aptratcn/trend-harvester) — Multi-platform trend research
